...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtusername.setText(PreferenceManager.getDefaultSharedPreferences(getApplicationContext()).getString("username_text",getString(R.string.pref_default_display_name)));
        //Check if search
    ...
    public void FilterAndBindData(){
        ...
        //Obtenir les thés selon le Filtre
        Filter f = loadFilter();
        ...
        if(teas.size() == 0) {
            //Affiche le message "Aucun thé trouvé"
        ...
        for (Tea t : teas) {
            ...
            final Drawable teaPitcureDrawable = DrawableCompat.wrap(getDrawable(R.drawable.ic_local_cafe_black_24dp));
            DrawableCompat.setTint(teaPitcureDrawable,getResources().getColor(android.R.color.background_light,null));
            imgTeaPicture.setImageDrawable(teaPitcureDrawable);
            //TxtButton
            ...
            txtBrewTimer.setText(getResources().getString(R.string.chronoLabel));
            ...
            imgChrono.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View imgB) {
                    imgChrono.setClickable(false);
                    new CountDownTimer(infusionTimeInMS,1000){
                    ...
                    txtChronometer.setText(ApplicationHelper.formatInfusionTime((infusionTimeInMS/1000) - 1));
                }
            });
    ...
    * */
    ...
    public void FillDBForFirstUse() {
        Tea t1 = new Tea("Lapsang souchong", "Lapsang souchong",
                ...
                EnumSet.of(HealthPropertyType.NONE), EnumSet.of(GoodWithType.NONE),160);
        Tea t2 = new Tea("Yingdehong", "Yingdehong",
                ...
                false, EnumSet.of(TeaType.BLACK),
                EnumSet.of(HealthPropertyType.NONE), EnumSet.of(GoodWithType.MILK),160);
        ...
        Tea t4 = new Tea("Munnar", "Munnar",
                ...
                false, EnumSet.of(TeaType.BLACK),
                EnumSet.of(HealthPropertyType.CAFFEINE), EnumSet.of(GoodWithType.MILK),160);
        ...
        Tea t6 = new Tea("Rize", "Rize",
                ...
                false, EnumSet.of(TeaType.BLACK),
                EnumSet.of(HealthPropertyType.CAFFEINE), EnumSet.of(GoodWithType.SUGAR),160);
        Tea t7 = new Tea("Huang Shan Mao Feng", "Huang Shan Mao Feng",
                ...
                false, EnumSet.of(TeaType.GREEN), EnumSet.of(HealthPropertyType.CAFFEINE,HealthPropertyType.ANTI_INFLAMMATORY), EnumSet.of(GoodWithType.NONE),30);
        Tea t8 = new Tea("Pingshui Gunpowder", "Le Gunpowder",
                ...
                false, EnumSet.of(TeaType.GREEN), EnumSet.of(HealthPropertyType.CAFFEINE,HealthPropertyType.ANTI_INFLAMMATORY), EnumSet.of(GoodWithType.SUGAR),20);
        Tea t9 = new Tea("Sencha", "Sencha",
                ...
                false, EnumSet.of(TeaType.GREEN), EnumSet.of(HealthPropertyType.CAFFEINE,HealthPropertyType.ANTI_INFLAMMATORY), EnumSet.of(GoodWithType.NONE),60);
        Tea t10 = new Tea("Bancha", "Bancha",
                ...
                false, EnumSet.of(TeaType.GREEN), EnumSet.of(HealthPropertyType.CAFFEINE), EnumSet.of(GoodWithType.NONE),30);
        Tea t11 = new Tea("Kukicha", "Kukicha",
                ...
                false, EnumSet.of(TeaType.GREEN), EnumSet.of(HealthPropertyType.ANTI_INFLAMMATORY), EnumSet.of(GoodWithType.NONE),30);
        ...
        Tea t13 = new Tea("Tieguanyin", "Tieguanyin",
                ...
                false, EnumSet.of(TeaType.OOLONG), EnumSet.of(HealthPropertyType.CAFFEINE), EnumSet.of(GoodWithType.NONE),120);
        Tea t14 = new Tea("Da Hong Pao", "Da Hong Pao",
                ...
                false, EnumSet.of(TeaType.OOLONG), EnumSet.of(HealthPropertyType.CAFFEINE,HealthPropertyType.ANTI_INFLAMMATORY), EnumSet.of(GoodWithType.SUGAR),120);
        Tea t15 = new Tea("Bai Mu Dan", "Bai Mu Dan",
                ...
                false, EnumSet.of(TeaType.WHITE), EnumSet.of(HealthPropertyType.CAFFEINE), EnumSet.of(GoodWithType.NONE),120);
        Tea t16 = new Tea("Pu'Er", "Pu'Er",
                ...
                false, EnumSet.of(TeaType.FERMENTED), EnumSet.of(HealthPropertyType.CAFFEINE,HealthPropertyType.ANTI_INFLAMMATORY), EnumSet.of(GoodWithType.NONE),600); //Yunnan H:C + T:F + G:N
